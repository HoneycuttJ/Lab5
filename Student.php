        ...
        <div class="d-flex" id="wrapper">
            ...
            <div class="border-end bg-white" id="sidebar-wrapper">
                ...
                <div class="list-group list-group-flush">
					<button class="list-group-item list-group-item-action list-group-item-light p-3" onclick="toggleDiv('professors')">Professors</button>
            ...
            <div id="page-content-wrapper">
                ...
                <div class="container-fluid">
					...
					<?php
						...
						$student_major = "Major_department"; // Example department value, replace with the actual value obtained from the faculty table
